...
# Delay for 3 seconds to let the user enjoy the portrait
sleep 3

echo "Starting the Arch Linux setup script..."


# Create common home directories
echo "Creating directories..."
mkdir -p ~/Documents ~/Downloads ~/Videos ~/Music ~/Pictures
echo "Directories created: Documents, Downloads, Videos, Music, Pictures."
